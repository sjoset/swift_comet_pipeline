...
# TODO: remove, we keep full path already
# def get_image_path_from_obs_log_row(
#     swift_data: SwiftDataset, obs_log_row
# ) -> pathlib.Path:
#     image_path = (
#         swift_data.get_observation_image_directory(
...
# TODO: rewrite this for using the full path stored in the observation log
# def get_image_from_obs_log_row(swift_data: SwiftDataset, obs_log_row) -> SwiftUvotImage:
...
# TODO: rewrite this for using the full path stored in the observation log
# def get_header_from_obs_log_row(swift_data: SwiftDataset, obs_log_row):
#     image_path = (
#         swift_data.get_observation_image_directory(
#             obsid=obs_log_row.OBS_ID, image_mode=obs_log_row.DATAMODE
#         )
