...
# We have two sources for the position of the comet: the pixel values we calculate based on JPL Horizons and WCS data for the image, and a manual user override
# We store both, so these handle reporting of the two positions
