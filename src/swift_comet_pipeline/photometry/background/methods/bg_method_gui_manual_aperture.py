...
from swift_comet_pipeline.photometry.background.methods.bg_method_aperture import (
...
def bg_gui_manual_aperture(img: SwiftUvotImage, filter_type: UvotFilter):
    """
...
class BackgroundAperturePlacementPlot:
    def __init__(self, img: SwiftUvotImage, filter_type: UvotFilter):
