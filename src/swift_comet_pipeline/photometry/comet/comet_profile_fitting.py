...
def fit_comet_profile_gaussian(comet_profile: CometProfile):
    ...
    fitted_gaussian = lsqf(
        gaussian, comet_profile.profile_axis_rs, comet_profile.pixel_values
    )
...
def plot_fitted_gaussian_profile(
    ...
    plt.scatter(comet_profile.profile_axis_rs, comet_profile.pixel_values)
    plt.plot(
        comet_profile.profile_axis_rs,
        fitted_model(comet_profile.profile_axis_rs),
    )
