...
def compare_comet_center_methods(uw1: SwiftUvotImage, uvv: SwiftUvotImage):
    ...
    peaks = {}
    imgs = {UvotFilter.uw1: uw1, UvotFilter.uvv: uvv}
    for filter_type in [UvotFilter.uw1, UvotFilter.uvv]:
    ...
    xdist = peaks[UvotFilter.uw1].x - peaks[UvotFilter.uvv].x
    ydist = peaks[UvotFilter.uw1].y - peaks[UvotFilter.uvv].y
