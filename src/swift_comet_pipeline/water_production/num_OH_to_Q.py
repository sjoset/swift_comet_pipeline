...
from swift_comet_pipeline.scp_types.compound.water_molecule_count import (
    WaterMoleculeCount,
)
...
def num_OH_to_Q_vectorial(
    ...
    """
    Uses a vectorial model to match *total number* of OH molecules in a coma to
    num_OH and produce an equivalent production rate
    If
    """
