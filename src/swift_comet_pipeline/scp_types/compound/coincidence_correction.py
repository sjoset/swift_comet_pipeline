...
from swift_comet_pipeline.scp_types.primitive.swift_pixel_resolution import (
    UvotPixelResolution,
)
...
class CoincidenceCorrection:
    ...
    def __init__(self) -> None:
        ...
        if not CoincidenceCorrection.kernel:
            for scale in [
                UvotPixelResolution.data_mode,
                UvotPixelResolution.event_mode,
            ]:
    ...
    def make_kernel(self, image_scale: UvotPixelResolution) -> np.ndarray:
        """
